  ...
  return (
    <div
      className={cn(
        ...
        "flex w-full items-center justify-between gap-3 border-b border-foreground/10 bg-white px-4 py-5  backdrop-blur-md dark:border-neutral-700 dark:bg-[#110E14] md:justify-end",
      )}
    >
      <Link href={"/"}>
